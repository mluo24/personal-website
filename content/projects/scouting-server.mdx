...
The data querying was not worked upon due to the pandemic, but previous methods such as team comparisons and simple JSTable views are still possible.

<!---
https://team1676.com/scouting/
-->
