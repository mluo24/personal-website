...
It is a CRUD app made with PHP and manually making connections to a database, and all the data can be viewed and exported easily based on what was needed for the graphs at the end of the project.
